...
public class AppConfig {
  @Bean
  ProductServicePort productService(ProductRepositoryPort productRepository, ReviewRepositoryPort reviewRepository) {
    return new ProductService(productRepository, reviewRepository);
  }
}
